...
var Canvas = React2.forwardRef((props, ref) => {
  ...
  return /* @__PURE__ */ React2.createElement(
    ...
    /* @__PURE__ */ React2.createElement(
      ...
      /* @__PURE__ */ React2.createElement("defs", null, /* @__PURE__ */ React2.createElement("filter", { id: "invert-alpha" }, /* @__PURE__ */ React2.createElement(
        "feColorMatrix",
        {
          type: "matrix",
      ...
      invert || pathGroups.map((pathGroup, i) => /* @__PURE__ */ React2.createElement(
        "g",
        {
          id: `${id}__stroke-group-${i}`,
          key: `${id}__stroke-group-${i}`,
...
var ReactSketchCanvas = React3.forwardRef((props, ref) => {
  ...
  const strokeColor = React3.useMemo(() => {
